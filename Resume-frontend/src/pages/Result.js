...
export default function Result() {
      ...
      <div className="min-h-screen flex items-center justify-center p-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 max-w-xl w-full text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300 mb-6">
            You don't have an analysis to view. Upload a resume and job description first.
          </p>
  ...
  const scoreMatch = analysis.match(/(\d{1,3})\s*\/\s*100|Compatibility Score[:\s]*([0-9]{1,3})/i);
    ...
    <div className="pt-32 min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-start justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">AI Analysis Result</h1>
        ...
        {safeScore !== null && (
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <div className="font-medium text-gray-700 dark:text-gray-200">Compatibility Score</div>
              <div className="text-sm font-semibold text-gray-700 dark:text-gray-200">{safeScore}/100</div>
            </div>
            <div className="w-full bg-gray-200 dark:bg-gray-800 rounded h-4">
              <div
                className="h-4 rounded bg-green-500"
                style={{ width: `${safeScore}%`, transition: "width 0.5s ease" }}
              />
            </div>
          </div>
        )}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
          <h2 className="text-lg font-semibold mb-2 text-gray-800 dark:text-white">Full Analysis</h2>
